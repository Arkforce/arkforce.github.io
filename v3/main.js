...
const columnMaterial = new THREE.MeshStandardMaterial({ color: 0x161b22, roughness: .55, metalness: .14 });
...
const plane = new THREE.Mesh(planeGeometry, new THREE.MeshBasicMaterial({ color: 0x3fb950, wireframe: true, transparent: true, opacity: .14 }));
plane.position.y = -.05; field.add(plane);

const orb = new THREE.Mesh(new THREE.SphereGeometry(.55, 28, 28), new THREE.MeshPhysicalMaterial({ color: 0xf0883e, roughness: .2, metalness: .1, clearcoat: 1 }));
